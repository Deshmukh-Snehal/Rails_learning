...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { equipments: @sport.equipments, name: @sport.name, players: @sport.players } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { equipments: @sport.equipments, name: @sport.name, players: @sport.players } }
