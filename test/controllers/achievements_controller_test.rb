...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { country: @achievement.country, medal_name: @achievement.medal_name, total_medals: @achievement.total_medals } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { country: @achievement.country, medal_name: @achievement.medal_name, total_medals: @achievement.total_medals } }
